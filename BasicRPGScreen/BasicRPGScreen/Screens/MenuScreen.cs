...
namespace BasicRPGScreen.Screens
{
    public abstract class MenuScreen : GameScreen
    {
        ...
        protected virtual void UpdateMenuEntryLocations()
        {
            ...
            foreach (var menuEntry in _menuEntries)  //CHANGE?
            {
        ...
        public override void Draw(GameTime gameTime)
        {
            ...
            var titleColor = new Color(192, 192, 192) * TransitionAlpha;  //CHANGE?
            const float titleScale = 1.25f;  //CHANGE?

            titlePosition.Y -= transitionOffset * 100;  //CHANGE?

            spriteBatch.DrawString(font, _menuTitle, titlePosition, titleColor,
                0, titleOrigin, titleScale, SpriteEffects.None, 0);  //CHANGE?
