...
namespace BasicRPGScreen.SpriteCode
{
    public class Wolf
    {
        ...
        public void LoadContent(ContentManager content)
        {
            ...
            textureAttack = content.Load<Texture2D>("S_Attack_Worf");
        ...
        public void Draw(GameTime gameTime, SpriteBatch spriteBatch, int animation)
        {
            ...
            spriteBatch.Draw(ActiveTexure.Item1, position, source, Color, 0, new Vector2(64, 64), 2f, spriteEffects, 0);
        }
    }
}
